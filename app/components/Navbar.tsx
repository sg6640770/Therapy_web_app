...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="bg-pink-100 text-gray-800 text-sm px-4 py-2 flex flex-col md:flex-row justify-between items-start md:items-center gap-1 md:gap-0 font-medium">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto truncate">
          {/* Location icon */}
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-green-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0" />
            <circle cx="12" cy="10" r="3" />
          </svg>
          <span className="truncate">1287 Maplewood Drive, Los Angeles, CA 90026</span>
        </div>
      </div>
